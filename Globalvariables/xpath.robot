...
${Clientlog}    //*[@id="new-client-invoiceLocation-client-logo"]
...
${India}    //*[@id="new-client-businessInfromation-country-option-100"]
${State}    //*[@id="root"]/div/div/main/div[2]/div/div/div[2]/div/div[1]/div/div/div/form/div[2]/div[5]/div/div/div/div[2]/button[2]
${AP}     //*[@id="new-client-businessInfromation-state-option-1"]
...
${Jobtitle}    //*[@id="new-client-accounts-contact-jobTitle"]
...
${CCountry}    //*[@id="vertical-tabpanel-0"]/div/div/div/form/div[1]/div[11]/div/div/div/div/button[2]
${CIndia}    //*[@id="new-client-accounts-contact-country-option-100"]
${CState}    //*[@id="vertical-tabpanel-0"]/div/div/div/form/div[1]/div[12]/div/div/div/div[2]/button[2]
${CAP}    //*[@id="new-client-accounts-contact-state-option-1"]
${CCity}    //*[@id="vertical-tabpanel-0"]/div/div/div/form/div[1]/div[10]/div/div/input
${CZipcode}    //*[@id="new-client-accounts-contact-zip"]
...
${LCity}    //*[@id="new-client-location-locationscity"]
${LCountry}    //*[@id="vertical-tabpanel-0"]/div/div/div/form/div[1]/div[4]/div/div/div/div/button[2]
${LIndia}    //*[@id="new-client-location-country-option-100"]
${LState}    //*[@id="vertical-tabpanel-0"]/div/div/div/form/div[1]/div[5]/div/div/div/div[2]/button[2]
${LAP}    //*[@id="new-client-location-state-option-1"]
${LZipcode}    //*[@id="new-client-location-locationszip"]
...
${timesheet_slctPlacement}  //*[@id="SubmitTimesheet-SelectPlacement-placements-state-placementID-option-3"]
${timesheet_UploadDocButton}    //*[@id="root"]/div/div/main/div[2]/div/div/div/div/div[1]/div[2]/div/div/div/label/span
